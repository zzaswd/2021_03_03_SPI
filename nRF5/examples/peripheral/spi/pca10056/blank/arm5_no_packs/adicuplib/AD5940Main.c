...
static int32_t AD5940PlatformCfg(void)
{
  ...
  clk_cfg.SysClkSrc = SYSCLKSRC_HFOSC; //16MHz
  clk_cfg.SysClkDiv = SYSCLKDIV_1; //16MHz/1 = 16mHz
...
void AD5940AMPStructInit(void)
{
  ...
  pAMPCfg->SensorBias = 120;   			/* Sensor bias voltage between reference and sense electrodes*/
	pAMPCfg->LptiaRtiaSel = LPTIARTIA_200R;
	pAMPCfg->LpTiaRl = LPTIARLOAD_50R;
